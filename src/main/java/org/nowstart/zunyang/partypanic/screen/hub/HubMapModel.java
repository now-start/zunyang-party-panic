...
public final class HubMapModel {
    ...
    public HubMapModel(PartyPanicGame game) {
        parseMapLayout();
        this.events = createEvents(game);
    }
    ...
    private List<HubMapEvent> createEvents(PartyPanicGame game) {
        return List.of(
                new HubMapEvent(
                        GameProgress.BROADCAST_DESK,
                        "방송 책상",
                ...
                new HubMapEvent(
                        ...
                        anchorOf('s').x(),
                        anchorOf('s').y(),
                        game::showStorageRoomScene
                ),
                new HubMapEvent(
                        GameProgress.CAKE_TABLE,
                        "케이크 테이블",

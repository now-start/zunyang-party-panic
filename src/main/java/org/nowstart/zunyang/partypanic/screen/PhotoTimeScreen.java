...
import org.nowstart.zunyang.partypanic.state.PhotoTimeStateMachine;
...
public final class PhotoTimeScreen extends ScreenAdapter {
    ...
    public PhotoTimeScreen(PartyPanicGame game, GameProgress progress) {
        this.game = game;
    ...
    private void handleInput() {
        ...
        if (stateMachine.isResult()) {
            ...
            if (Gdx.input.isKeyJustPressed(Input.Keys.H)) {
                game.finishPhotoTimeMinigame(stateMachine.getFinalScore());
            }
        }
    }
    ...
    private void drawStatusPanel() {
        ...
        drawLine("최고 점수 " + progress.getBestScore(GameProgress.PHOTO_TIME), left, top - 66f, 0.92f, TEXT_MINT);

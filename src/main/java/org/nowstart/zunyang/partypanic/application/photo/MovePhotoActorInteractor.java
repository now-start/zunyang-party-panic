...
public final class MovePhotoActorInteractor implements MovePhotoActorUseCase {
    ...
    @Override
    public PhotoBayViewResult move(MovePhotoActorCommand command) {
        ...
        PhotoBayState nextState = currentState.move(command.direction());
